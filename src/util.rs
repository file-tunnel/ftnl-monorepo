...
use ore_mcp_process::{run_bounded, ProcessError, ProcessLimits};
...
fn render_process_error(program: &str, limits: CommandOutputLimits, error: ProcessError) -> String {
    match error {
        ...
        ProcessError::MissingPipe("stdout") => "subprocess stdout pipe is unavailable".to_string(),
        ProcessError::MissingPipe("stderr") => "subprocess stderr pipe is unavailable".to_string(),
