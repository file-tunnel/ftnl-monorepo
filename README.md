...
Pinned, reproducible workspace for the File Tunnel platform. Canonical applications
under `apps/` keep their own package boundaries and CI while this repository
provides the tested integration view.
...
apps/
  ...
  infra/           file-tunnel/ftnl-infra (git submodule)
